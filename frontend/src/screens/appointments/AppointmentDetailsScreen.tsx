      ...
      <Content>
        ...
        {item ? (
          <>
            ...
            {role === 'Doctor' && item.patient_id ? (
              <TouchableOpacity style={styles.outlineButton} onPress={() => navigation.navigate('DoctorLabRequest', { appointmentId: item.id, patientId: item.patient_id, patientName: item.patients?.name })}>
